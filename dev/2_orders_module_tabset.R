    ...
    fluidRow(
      tabBox(
        ...
        tabPanel(
          " ",
          value = ns("awaiting"),
          icon = icon("exclamation", style = "color: #fff;"),
          fluidRow(
            column(
              12,
        ...
        tabPanel(
          " ",
          value = ns("ratings"),
          icon = icon("star", style = "color: #fff;"),
          fluidRow(
            column(
              12,
    ...
    fluidRow(
      column(
        ...
        div(
          ...
          hr()#,
          # htmlTemplate(
          #   filename = "www/html/rating_card.html",
          #   average_rating = avg,
          #   number_of_reviews = tot,
          #   num_five_star = five,
          #   num_four_star = four,
